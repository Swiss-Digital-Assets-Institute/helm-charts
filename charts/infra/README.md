...
![Version: 1.7.73](https://img.shields.io/badge/Version-1.7.73-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| aws.mq.additional_tags | object | `{}` |  |
| aws.mq.adminPasswordSecretRef.key | string | `"RABBITMQ_ADMIN_PASSWORD"` |  |
| aws.mq.adminUsername | string | `""` |  |
| aws.mq.autoMinorVersionUpgrade | bool | `true` |  |
| aws.mq.brokerNameOverride | string | `""` |  |
| aws.mq.deploymentMode | string | `"SINGLE_INSTANCE"` |  |
| aws.mq.enabled | bool | `false` |  |
| aws.mq.engineVersion | string | `"3.13"` |  |
| aws.mq.instanceType | string | `"mq.m5.large"` |  |
| aws.mq.maintenanceWindowStartTime.dayOfWeek | string | `"SUNDAY"` |  |
| aws.mq.maintenanceWindowStartTime.timeOfDay | string | `"03:00"` |  |
| aws.mq.maintenanceWindowStartTime.timeZone | string | `"UTC"` |  |
| aws.mq.publiclyAccessible | bool | `false` |  |
